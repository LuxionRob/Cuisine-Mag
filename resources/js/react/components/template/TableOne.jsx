    ...
    return (
        <div className="rounded-sm border border-stroke bg-white px-5 pb-2.5 pt-6 shadow-default sm:px-7.5 xl:pb-1 dark:border-strokedark dark:bg-boxdark">
            ...
            <div className="flex flex-col">
                <div className="bg-gray-2 grid grid-cols-3 rounded-sm sm:grid-cols-5 dark:bg-meta-4">
                ...
                <div className="grid grid-cols-3 border-b border-stroke sm:grid-cols-5 dark:border-strokedark">
                    <div className="flex items-center gap-3 p-2.5 xl:p-5">
                        ...
                        <p className="hidden text-black sm:block dark:text-white">Twitter</p>
                    </div>
                ...
                <div className="grid grid-cols-3 sm:grid-cols-5">
                    <div className="flex items-center gap-3 p-2.5 xl:p-5">
                        ...
                        <p className="hidden text-black sm:block dark:text-white">Facebook</p>
                    </div>
