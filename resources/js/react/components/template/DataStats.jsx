    ...
    return (
        <div className="col-span-12 rounded-sm border border-stroke bg-white p-7.5 shadow-default dark:border-strokedark dark:bg-boxdark">
            <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-4 xl:gap-0">
                <div className="flex items-center justify-center gap-2 border-b border-stroke pb-5 xl:border-b-0 xl:border-r xl:pb-0 dark:border-strokedark">
                    <div>
                        <h4 className="mb-0.5 text-xl font-semibold text-black md:text-title-lg dark:text-white">
                            $4,350
                        </h4>
                ...
                <div className="flex items-center justify-center gap-2 border-b border-stroke pb-5 sm:border-b-0 sm:pb-0 xl:border-r dark:border-strokedark">
                    <div>
                        <h4 className="mb-0.5 text-xl font-semibold text-black md:text-title-lg dark:text-white">
                            54%
                        </h4>
