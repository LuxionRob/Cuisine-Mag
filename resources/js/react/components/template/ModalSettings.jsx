                    ...
                    <form>
                        <div className="grid grid-cols-3 justify-normal gap-5">
                            <div className="form-group col-span-3 w-full">
                                ...
                                <input
                                    className="bg-gray w-full rounded border border-stroke py-3 pl-3 pr-4.5 text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary"
                                    name="id"
                        ...
                        {errors.filter(item => !item.startsWith('INVALID_ID')).length > 0 && (
                            <div className="error">
                                Please input{' '}
                                {errors.filter(item => !item.startsWith('INVALID_ID')).join(', ')}
                            </div>
                        )}

                        <br></br>
                        <button
                            className="btn text-gray flex justify-center rounded bg-primary px-6 py-2 font-medium hover:shadow-1"
                            type="submit"
